...
{ 
    ...
    { 
        ...
        public override void Serialize(IDataWriter writer)
        {
            ...
            if (poiLabelId < 0)
            {
                throw new Exception("Forbidden value (" + poiLabelId + ") on element poiLabelId.");
            }
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            if (direction < 0)
            {
                throw new Exception("Forbidden value (" + direction + ") on element of TreasureHuntStepFollowDirectionToPOI.direction.");
            }

            poiLabelId = (short)reader.ReadVarUhShort();
            if (poiLabelId < 0)
            {
                throw new Exception("Forbidden value (" + poiLabelId + ") on element of TreasureHuntStepFollowDirectionToPOI.poiLabelId.");
            }
