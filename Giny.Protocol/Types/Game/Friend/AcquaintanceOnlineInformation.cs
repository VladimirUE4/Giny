...
{ 
    ...
    { 
        ...
        public AcquaintanceOnlineInformation(long playerId,string playerName,short moodSmileyId,PlayerStatus status)
        {
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            if (playerId < 0 || playerId > 9.00719925474099E+15)
            {
                throw new Exception("Forbidden value (" + playerId + ") on element of AcquaintanceOnlineInformation.playerId.");
            }
            ...
            if (moodSmileyId < 0)
            {
                throw new Exception("Forbidden value (" + moodSmileyId + ") on element of AcquaintanceOnlineInformation.moodSmileyId.");
            }
