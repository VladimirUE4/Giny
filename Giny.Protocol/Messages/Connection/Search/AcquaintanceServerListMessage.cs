...
{ 
    ...
    { 
        public new const ushort Id = 5705;
        ...
        public override void Serialize(IDataWriter writer)
        {
            ...
            for (uint _i1 = 0;_i1 < servers.Length;_i1++)
            {
                if (servers[_i1] < 0)
                {
                    throw new Exception("Forbidden value (" + servers[_i1] + ") on element 1 (starting at 1) of servers.");
                }
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            for (uint _i1 = 0;_i1 < _serversLen;_i1++)
            {
                ...
                if (_val1 < 0)
                {
                    throw new Exception("Forbidden value (" + _val1 + ") on elements of servers.");
                }
