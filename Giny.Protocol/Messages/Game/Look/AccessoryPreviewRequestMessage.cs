...
{ 
    ...
    { 
        public new const ushort Id = 5863;
        ...
        public override void Serialize(IDataWriter writer)
        {
            ...
            for (uint _i1 = 0;_i1 < genericId.Length;_i1++)
            {
                if (genericId[_i1] < 0)
                {
                    throw new Exception("Forbidden value (" + genericId[_i1] + ") on element 1 (starting at 1) of genericId.");
                }
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            for (uint _i1 = 0;_i1 < _genericIdLen;_i1++)
            {
                ...
                if (_val1 < 0)
                {
                    throw new Exception("Forbidden value (" + _val1 + ") on elements of genericId.");
                }
