...
{ 
    ...
    { 
        public new const ushort Id = 2448;
        ...
        public override void Serialize(IDataWriter writer)
        {
            ...
            for (uint _i1 = 0;_i1 < presetIds.Length;_i1++)
            {
                if (presetIds[_i1] < 0)
                {
                    throw new Exception("Forbidden value (" + presetIds[_i1] + ") on element 1 (starting at 1) of presetIds.");
                }
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            for (uint _i1 = 0;_i1 < _presetIdsLen;_i1++)
            {
                ...
                if (_val1 < 0)
                {
                    throw new Exception("Forbidden value (" + _val1 + ") on elements of presetIds.");
                }
