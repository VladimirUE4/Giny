...
{ 
    ...
    { 
        public new const ushort Id = 6370;
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            if (fightId < 0 || fightId > 9.00719925474099E+15)
            {
                throw new Exception("Forbidden value (" + fightId + ") on element of GuildFightPlayersHelpersLeaveMessage.fightId.");
            }

            playerId = (long)reader.ReadVarUhLong();
            if (playerId < 0 || playerId > 9.00719925474099E+15)
            {
                throw new Exception("Forbidden value (" + playerId + ") on element of GuildFightPlayersHelpersLeaveMessage.playerId.");
            }
