...
{ 
    ...
    { 
        public new const ushort Id = 7602;
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            if (houseId < 0)
            {
                throw new Exception("Forbidden value (" + houseId + ") on element of GuildHouseRemoveMessage.houseId.");
            }

            instanceId = (int)reader.ReadInt();
            if (instanceId < 0)
            {
                throw new Exception("Forbidden value (" + instanceId + ") on element of GuildHouseRemoveMessage.instanceId.");
            }
