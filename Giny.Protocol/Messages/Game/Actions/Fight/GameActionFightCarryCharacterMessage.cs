...
{ 
    ...
    { 
        public new const ushort Id = 5624;
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            if (targetId < -9.00719925474099E+15 || targetId > 9.00719925474099E+15)
            {
                throw new Exception("Forbidden value (" + targetId + ") on element of GameActionFightCarryCharacterMessage.targetId.");
            }

            cellId = (short)reader.ReadShort();
            if (cellId < -1 || cellId > 559)
            {
                throw new Exception("Forbidden value (" + cellId + ") on element of GameActionFightCarryCharacterMessage.cellId.");
            }
