...
{ 
    ...
    { 
        public new const ushort Id = 6357;
        ...
        public GameActionFightDodgePointLossMessage(double targetId,short amount)
        {
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            if (targetId < -9.00719925474099E+15 || targetId > 9.00719925474099E+15)
            {
                throw new Exception("Forbidden value (" + targetId + ") on element of GameActionFightDodgePointLossMessage.targetId.");
            }

            amount = (short)reader.ReadVarUhShort();
            if (amount < 0)
            {
                throw new Exception("Forbidden value (" + amount + ") on element of GameActionFightDodgePointLossMessage.amount.");
            }
