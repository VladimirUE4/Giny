...
{ 
    ...
    { 
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            if (hostUID < 0)
            {
                throw new Exception("Forbidden value (" + hostUID + ") on element of WrapperObjectDissociateRequestMessage.hostUID.");
            }

            hostPos = (byte)reader.ReadSByte();
            if (hostPos < 0 || hostPos > 255)
            {
                throw new Exception("Forbidden value (" + hostPos + ") on element of WrapperObjectDissociateRequestMessage.hostPos.");
            }
