...
{ 
    ...
    { 
        public new const ushort Id = 2767;
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            if (worldX < -255 || worldX > 255)
            {
                throw new Exception("Forbidden value (" + worldX + ") on element of ExchangeGuildTaxCollectorGetMessage.worldX.");
            }

            worldY = (short)reader.ReadShort();
            if (worldY < -255 || worldY > 255)
            {
                throw new Exception("Forbidden value (" + worldY + ") on element of ExchangeGuildTaxCollectorGetMessage.worldY.");
            }

            mapId = (double)reader.ReadDouble();
            if (mapId < 0 || mapId > 9.00719925474099E+15)
            {
                throw new Exception("Forbidden value (" + mapId + ") on element of ExchangeGuildTaxCollectorGetMessage.mapId.");
            }

            subAreaId = (short)reader.ReadVarUhShort();
            if (subAreaId < 0)
            {
                throw new Exception("Forbidden value (" + subAreaId + ") on element of ExchangeGuildTaxCollectorGetMessage.subAreaId.");
            }
            ...
            if (callerId < 0 || callerId > 9.00719925474099E+15)
            {
                throw new Exception("Forbidden value (" + callerId + ") on element of ExchangeGuildTaxCollectorGetMessage.callerId.");
            }
            ...
            if (experience < -9.00719925474099E+15 || experience > 9.00719925474099E+15)
            {
                throw new Exception("Forbidden value (" + experience + ") on element of ExchangeGuildTaxCollectorGetMessage.experience.");
            }

            pods = (short)reader.ReadVarUhShort();
            if (pods < 0)
            {
                throw new Exception("Forbidden value (" + pods + ") on element of ExchangeGuildTaxCollectorGetMessage.pods.");
            }
