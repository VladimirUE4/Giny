...
{ 
    ...
    { 
        public new const ushort Id = 8081;
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            if (worldX < -255 || worldX > 255)
            {
                throw new Exception("Forbidden value (" + worldX + ") on element of ExchangeMountsTakenFromPaddockMessage.worldX.");
            }

            worldY = (short)reader.ReadShort();
            if (worldY < -255 || worldY > 255)
            {
                throw new Exception("Forbidden value (" + worldY + ") on element of ExchangeMountsTakenFromPaddockMessage.worldY.");
            }
