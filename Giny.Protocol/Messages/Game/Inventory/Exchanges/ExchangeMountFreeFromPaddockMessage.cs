...
{ 
    ...
    { 
        public new const ushort Id = 9283;
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            if (worldX < -255 || worldX > 255)
            {
                throw new Exception("Forbidden value (" + worldX + ") on element of ExchangeMountFreeFromPaddockMessage.worldX.");
            }

            worldY = (short)reader.ReadShort();
            if (worldY < -255 || worldY > 255)
            {
                throw new Exception("Forbidden value (" + worldY + ") on element of ExchangeMountFreeFromPaddockMessage.worldY.");
            }
