...
{ 
    ...
    { 
        public new const ushort Id = 3154;
        ...
        public override void Serialize(IDataWriter writer)
        {
            ...
            for (uint _i2 = 0;_i2 < referenceIds.Length;_i2++)
            {
                ...
                {
                    throw new Exception("Forbidden value (" + referenceIds[_i2] + ") on element 2 (starting at 1) of referenceIds.");
                }
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            for (uint _i2 = 0;_i2 < _referenceIdsLen;_i2++)
            {
                ...
                if (_val2 < 0)
                {
                    throw new Exception("Forbidden value (" + _val2 + ") on elements of referenceIds.");
                }
