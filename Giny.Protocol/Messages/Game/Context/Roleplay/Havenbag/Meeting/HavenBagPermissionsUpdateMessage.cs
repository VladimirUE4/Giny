...
{ 
    ...
    { 
        public new const ushort Id = 2326;
        ...
        public override void Serialize(IDataWriter writer)
        {
            if (permissions < 0)
            {
                throw new Exception("Forbidden value (" + permissions + ") on element permissions.");
            }
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            if (permissions < 0)
            {
                throw new Exception("Forbidden value (" + permissions + ") on element of HavenBagPermissionsUpdateMessage.permissions.");
            }
