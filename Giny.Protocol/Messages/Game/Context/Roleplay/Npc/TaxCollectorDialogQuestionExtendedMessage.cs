...
{ 
    ...
    { 
        public new const ushort Id = 9386;
        ...
        public TaxCollectorDialogQuestionExtendedMessage(short maxPods,short prospecting,short wisdom,byte taxCollectorsCount,int taxCollectorAttack,long kamas,long experience,int pods,long itemsValue)
        {
        ...
        public override void Serialize(IDataWriter writer)
        {
            ...
            if (wisdom < 0)
            {
                throw new Exception("Forbidden value (" + wisdom + ") on element wisdom.");
            }
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            if (maxPods < 0)
            {
                throw new Exception("Forbidden value (" + maxPods + ") on element of TaxCollectorDialogQuestionExtendedMessage.maxPods.");
            }

            prospecting = (short)reader.ReadVarUhShort();
            if (prospecting < 0)
            {
                throw new Exception("Forbidden value (" + prospecting + ") on element of TaxCollectorDialogQuestionExtendedMessage.prospecting.");
            }

            wisdom = (short)reader.ReadVarUhShort();
            if (wisdom < 0)
            {
                throw new Exception("Forbidden value (" + wisdom + ") on element of TaxCollectorDialogQuestionExtendedMessage.wisdom.");
            }

            taxCollectorsCount = (byte)reader.ReadByte();
            if (taxCollectorsCount < 0)
            {
                throw new Exception("Forbidden value (" + taxCollectorsCount + ") on element of TaxCollectorDialogQuestionExtendedMessage.taxCollectorsCount.");
            }
            ...
            if (kamas < 0 || kamas > 9.00719925474099E+15)
            {
                throw new Exception("Forbidden value (" + kamas + ") on element of TaxCollectorDialogQuestionExtendedMessage.kamas.");
            }

            experience = (long)reader.ReadVarUhLong();
            if (experience < 0 || experience > 9.00719925474099E+15)
            {
                throw new Exception("Forbidden value (" + experience + ") on element of TaxCollectorDialogQuestionExtendedMessage.experience.");
            }

            pods = (int)reader.ReadVarUhInt();
            if (pods < 0)
            {
                throw new Exception("Forbidden value (" + pods + ") on element of TaxCollectorDialogQuestionExtendedMessage.pods.");
            }

            itemsValue = (long)reader.ReadVarUhLong();
            if (itemsValue < 0 || itemsValue > 9.00719925474099E+15)
            {
                throw new Exception("Forbidden value (" + itemsValue + ") on element of TaxCollectorDialogQuestionExtendedMessage.itemsValue.");
            }
