...
{ 
    ...
    { 
        public new const ushort Id = 6788;
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            if (pageIndex < 0)
            {
                throw new Exception("Forbidden value (" + pageIndex + ") on element of HouseToSellListMessage.pageIndex.");
            }

            totalPage = (short)reader.ReadVarUhShort();
            if (totalPage < 0)
            {
                throw new Exception("Forbidden value (" + totalPage + ") on element of HouseToSellListMessage.totalPage.");
            }
