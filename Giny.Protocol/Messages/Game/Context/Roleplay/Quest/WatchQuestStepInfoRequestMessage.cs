...
{ 
    ...
    { 
        ...
        public WatchQuestStepInfoRequestMessage(long playerId)
        {
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            if (playerId < 0 || playerId > 9.00719925474099E+15)
            {
                throw new Exception("Forbidden value (" + playerId + ") on element of WatchQuestStepInfoRequestMessage.playerId.");
            }
