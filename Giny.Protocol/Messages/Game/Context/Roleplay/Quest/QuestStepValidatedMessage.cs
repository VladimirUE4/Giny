...
{ 
    ...
    { 
        public new const ushort Id = 5695;
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            if (questId < 0)
            {
                throw new Exception("Forbidden value (" + questId + ") on element of QuestStepValidatedMessage.questId.");
            }

            stepId = (short)reader.ReadVarUhShort();
            if (stepId < 0)
            {
                throw new Exception("Forbidden value (" + stepId + ") on element of QuestStepValidatedMessage.stepId.");
            }
