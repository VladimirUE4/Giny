...
{ 
    ...
    { 
        public new const ushort Id = 8473;
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            if (questType < 0)
            {
                throw new Exception("Forbidden value (" + questType + ") on element of TreasureHuntRequestAnswerMessage.questType.");
            }

            result = (byte)reader.ReadByte();
            if (result < 0)
            {
                throw new Exception("Forbidden value (" + result + ") on element of TreasureHuntRequestAnswerMessage.result.");
            }
