...
{ 
    ...
    { 
        public new const ushort Id = 7811;
        ...
        public override void Serialize(IDataWriter writer)
        {
            ...
            for (uint _i1 = 0;_i1 < destinations.Length;_i1++)
            {
                ...
                {
                    throw new Exception("Forbidden value (" + destinations[_i1] + ") on element 1 (starting at 1) of destinations.");
                }
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            for (uint _i1 = 0;_i1 < _destinationsLen;_i1++)
            {
                ...
                {
                    throw new Exception("Forbidden value (" + _val1 + ") on elements of destinations.");
                }
