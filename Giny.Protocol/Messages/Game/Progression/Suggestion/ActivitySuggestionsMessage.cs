    ...
    { 
        ...
        public override void Serialize(IDataWriter writer)
        {
            ...
            for (uint _i1 = 0;_i1 < lockedActivitiesIds.Length;_i1++)
            {
                ...
                {
                    throw new Exception("Forbidden value (" + lockedActivitiesIds[_i1] + ") on element 1 (starting at 1) of lockedActivitiesIds.");
                }
            ...
            for (uint _i2 = 0;_i2 < unlockedActivitiesIds.Length;_i2++)
            {
                ...
                {
                    throw new Exception("Forbidden value (" + unlockedActivitiesIds[_i2] + ") on element 2 (starting at 1) of unlockedActivitiesIds.");
                }
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            for (uint _i1 = 0;_i1 < _lockedActivitiesIdsLen;_i1++)
            {
                ...
                if (_val1 < 0)
                {
                    throw new Exception("Forbidden value (" + _val1 + ") on elements of lockedActivitiesIds.");
                }
            ...
            for (uint _i2 = 0;_i2 < _unlockedActivitiesIdsLen;_i2++)
            {
                ...
                if (_val2 < 0)
                {
                    throw new Exception("Forbidden value (" + _val2 + ") on elements of unlockedActivitiesIds.");
                }
