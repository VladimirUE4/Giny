...
{ 
    ...
    { 
        public new const ushort Id = 9750;
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            if (subAreaId < 0)
            {
                throw new Exception("Forbidden value (" + subAreaId + ") on element of PrismFightAttackerAddMessage.subAreaId.");
            }

            fightId = (short)reader.ReadVarUhShort();
            if (fightId < 0)
            {
                throw new Exception("Forbidden value (" + fightId + ") on element of PrismFightAttackerAddMessage.fightId.");
            }
